            ...
            <div className="grid gap-4 md:grid-cols-2">
              {classes.map((cls) => {
                ...
                const attendanceWindowEnd = new Date(
                  startTime.getTime() + 10 * 60000
                );

                const isWithinAttendanceWindow =
                  currentTime >= startTime && currentTime <= attendanceWindowEnd;

                const renderer = ({ minutes, seconds, completed }) => {
                  if (completed) {
                    return <span>Attendance window closed</span>;
                  } else {
                    return (
                      <span>
                ...
                const isButtonDisabled =
                  currentTime > endTime || isAttendanceMarked;
